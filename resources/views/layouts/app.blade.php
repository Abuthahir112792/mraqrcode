...
<head>
	...
	<!-- GOOGLE FONTS -->
	<link href="https://fonts.googleapis.com/css2?family=Mogra&family=Nova+Oval&display=swap" rel="stylesheet">
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="96x96" href="{{asset('theme/assets/img/logo.png')}}">
	<link rel="icon" type="image/png" sizes="96x96" href="{{asset('theme/assets/img/logo.png')}}">
