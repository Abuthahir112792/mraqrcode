                ...
                <div class="modal-body">
                    <form action="{{ route('admin.addProductUpdate') }}" method="post" id="incoming_croduct_form" enctype="multipart/form-data">
                        ...
                        <div class="row form-group d-flex">
                          ...
                          <div class="row form-group d-flex">
                            <label class="control-label col-md-4">Product Name (English):</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control en_product_title" name="en_product_title"
                                id="en_product_title" placeholder="Enter Product Name (English)" require/>
                            </div>
                          </div>
                          <div class="row form-group d-flex">
                            <label class="control-label col-md-4">Product Name (Arabic):</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control ar_product_title" name="ar_product_title"
                                id="ar_product_title" placeholder="Enter Product Name (Arabic)" require/>
                            </div>
                          </div>
                          <div class="row form-group d-flex">
                            <label class="control-label col-md-4">Product Description (English):</label>
                            <div class="col-md-8">
                                <textarea name="en_product_description" id="en_product_description" class="form-control en_product_description" placeholder="Enter Product Description (English)"></textarea>
                            </div>
                          </div>
                          <div class="row form-group d-flex">
                            <label class="control-label col-md-4">Product Description (Arabic):</label>
                            <div class="col-md-8">
                                <textarea name="ar_product_description" id="ar_product_description" class="form-control ar_product_description" placeholder="Enter Product Description (Arabic)"></textarea>
                            </div>
                          </div>
                          <div class="row form-group d-flex">
                            <label class="control-label col-md-4">Product Price (English):</label>
                            <div class="col-md-8">
                                <input type="Number" class="form-control en_product_price" name="en_product_price" id="en_product_price" placeholder="Enter Product Price (English)"  autocomplete="off" require/>
                            </div>
                          </div>
                          <div class="row form-group d-flex">
                            <label class="control-label col-md-4">Product Price (Arabic):</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control ar_product_price" name="ar_product_price" id="ar_product_price" placeholder="Enter Product Price (Arabic)"  autocomplete="off" require/>
                            </div>
                          </div>
                          <div class="row form-group d-flex">
                            <label class="control-label col-md-4">Product Image :</label>
                            <div class="col-md-8">
                                <input type="hidden" name="product_image_url" id="product_image_url" value="" > 
