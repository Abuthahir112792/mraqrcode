...
@section('footer')
    <footer style="text-align: center;" >
        <div class="container">
            <span 
            style="color:black"
            class="other-links">{{ trans('front/label.forgot.are_you_a_newbie') }} <a style="color: #cfb62c;text-decoration: none !important;" href="{{ route('front.register') }}">{{ trans('front/label.forgot.sign_up') }}</a></span>
        </div>
    </footer>
@stop
