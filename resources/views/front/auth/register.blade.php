...
@section('footer')
    <footer style="text-align: center;" >
        <div class="container">
        <span style="color:black" class="other-links">{{ __('front/label.login.are_you_a_newbie') }} <a style="color: #cfb62c;text-decoration: none !important;" href="{{ route('front.login.show') }}">{{ __('front/label.login.sign_in') }}</a></span>
        </div>
    </footer>
@stop
