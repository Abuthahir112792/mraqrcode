            ...
            <!-- contact -->
                ...
                <div class="contact-agileinfo">
                    ...
                    <div class="back-link mt-5 text-center">
                        <a style="color: #cfb62c;text-decoration: none !important;" href="{{ route('front.home') }}"><< {{ __('front/label.otp_verification.back') }}</a>
                    </div>
                    </div>
                </div>
...
@section('footer')
    <footer style="text-align: center;" >
        <div class="container">
            <span 
            style="color:black"
            class="other-links">{{ __('front/label.otp_verification.i_am_already_a_member') }} <a style="color: #cfb62c;text-decoration: none !important;" href="{{ route('front.login.show') }}">{{ __('front/label.otp_verification.sign_in') }}</a></span>
        </div>
    </footer>
@stop
